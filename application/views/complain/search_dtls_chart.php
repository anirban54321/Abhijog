                                                                    ...
                                                                    <tr class='alert-primary'>
                                                                        ...
                                                                        <td>
                                                                                <?php if($r->mt_priority=="1"){?>
                                                                                    <img src="<?=base_url()?>assets/images/high.png" alt="user" class="rounded-circle" width="70" alt="High">
                                                                                <?php } ?>
                                                                                <?php if($r->mt_priority=="2"){?>
                                                                                    <img src="<?=base_url()?>assets/images/medium.png" alt="user" class="rounded-circle" width="70" alt="Medium">                                                                        
                                                                                <?php } ?>
                                                                                <?php if($r->mt_priority=="3"){?>
                                                                                    <img src="<?=base_url()?>assets/images/low.png" alt="user" class="rounded-circle" width="70" alt="Low">                                                                        
                                                                                <?php } ?>
                                                                        </td>
                                                                        <td><?=$r->mt_type?></td>
